...
public class SqlDatabaseOperations implements DatabaseOperations {

    static final String JDBC_DRIVER = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
    static final String DB_URL = "jdbc:sqlserver://172.16.1.111;user=kafka;password=kafka@123;database=kafka_POC";
